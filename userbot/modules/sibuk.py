...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"__🔥 SIBUK__\n\n╭╼══════════════╾\n**Maaf Kyud {ALIVE_NAME} Sedang SIBUK**\n╰╼═════════╾",
    f"__🔥 SIBUK__\n\n╭╼══════════════╾\n**Kyud {ALIVE_NAME} Sedang SIBUK**\n**Tunggu Sampai Online Kembali**\n╰╼═════════╾",
...
CMD_HELP.update(
    {
        "sibuk": "**✘ Plugin : **`sibuk`\
        \n\n  •  **Perintah :** `.sibuk`\
        \n  •  **Function : **Memberi tahu kalau Kyud sedang SIBUK , dan menguubah nama belakang menjadi ⚡️𝗦𝗜𝗕𝗨𝗞⚡️\
