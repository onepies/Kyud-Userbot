...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Maaf Kyud Media Tidak Valid.```"
PP_CHANGED = "```Kyud, Foto Profil Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Kyud, Mohon Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Kyud, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Kyud, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Kyud, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
